...
window.isWebkit = checkWebKit();
window.isWebkit = (checkWebKit() !== null);
// window.isiPad = true;
...
window.androidVersion = parseFloat(getAndroidVersion());
window.canPlayMP4 = window._canPlayMP4();
window.isiPhone = (navigator.userAgent.match(/iPhone/i) || (navigator.userAgent.match(/iPod/i)));
...
// assign classes to the body tag, conditional upon device and browser
$(function() {
    if (window.isMobile)    { $('body').addClass('mobile');    }
    if (window.isDesktop)   { $('body').addClass('desktop');   }
//    if (window.isAndroid)   { $('body').addClass('android');   }
//    if (window.isWebkit)    { $('body').addClass('webkit');    }
//    if (window.isiPad)      { $('body').addClass('ipad');      }
//    if (window.isFirefox)   { $('body').addClass('firefox');   }
